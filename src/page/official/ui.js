...
export function ui() {
    ...
    const jsdom = node.div().setStyle({ marginBottom: '50px' }).setChildren([
        ...
        node.div().setStyle({ display: 'flex', alignItems: 'center' }).setChildren([
            node.divimg('', 'sample2.png').setStyle({ border: '3px solid #333' })
        ]),
        node.hr().setStyle({ margin: '20px 0' }),
        ...
        node.div().setChildren([
            node.scroller('', '200px', '200px', '', '', '-9px', '1px', 0, node.img().setSrc('sample.png').setStyle({ width: '300px', height: '300px', filter: 'grayscale(1)' })).setStyle({ marginRight: '15px' }),
            node.scroller('', '200px', '200px', '', '', '-9px', '1px', 1, node.img().setSrc('sample.png').setStyle({ width: '300px', height: '300px', filter: 'grayscale(1)' })).setStyle({ marginRight: '15px' }),
            node.scroller('', '200px', '200px', '', '', '-9px', '1px', 2, node.img().setSrc('sample.png').setStyle({ width: '300px', height: '300px', filter: 'grayscale(1)' })).setStyle({ marginRight: '15px' }),
            node.scroller('', '200px', '200px', 'rgb(187, 253, 111)', '#333', '-9px', '1px', 2, node.img().setSrc('sample.png').setStyle({ width: '300px', height: '300px', filter: 'grayscale(1)' }))
        ]),
        node.hr().setStyle({ margin: '20px 0' }),
